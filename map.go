...
//
// For every item in `seq`, the `mapper` func will be called and passed that item as its sole argument. The output of the `mapper` func will then be included in the output [iter.Seq].
//
